...
class IntroductionManager extends HorizontalLayout with Fragmented {
  
  def getFragment() = "intro"
  setSpacing(true)
  setMargin(true)
  setWidth("100%")
  ...
  val form = new IntroductionForm
  
  val cpanel = new Panel("Introduce your friends to each other")
  cpanel.setWidth("100%")
